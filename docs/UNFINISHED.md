...
незавершённого. Гэпы G1-G4 ниже пришли из отдельного gap-ресёрча от 2026-08-28; сам план-документ
жил вне репозитория и не сохранён — статусы гэпов здесь самодостаточны.
